...
const icons: Record<string, string> = {
  ...
  join: "M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z",
  activities: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
};

export async function getStaticPaths() {
  return STATIC_OG_PAGES.map((page) => ({
...
export async function GET({ params, props }: { params: any; props: any }) {
  ...
  const [fontData, regularFontData] = await fontDataPromise;
